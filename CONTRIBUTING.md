# Contributing to FactReach

Thank you for your interest in contributing to FactReach! This document provides guidelines and instructions for contributing.
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/FactReach.git
cd FactReach
...
FactReach uses a unified channel interface. To add a new platform:

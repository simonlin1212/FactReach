# -*- coding: utf-8 -*-
"""
FactReach MCP Server — expose doctor/status as MCP tool.

Run: python -m agent_reach.integrations.mcp_server

FactReach is an installer + doctor tool. For actual reading/searching,
...
def create_server():
    if not HAS_MCP:
        print(
            ...
            "'factreach[mcp] @ "
            "https://github.com/simonlin1212/FactReach/archive/main.zip'",
            file=sys.stderr,
        )
        sys.exit(1)

    server = Server("factreach")
    ...
    async def list_tools():
        return [
            Tool(name="get_status",
                 description="Get FactReach status: which channels are installed and active.",

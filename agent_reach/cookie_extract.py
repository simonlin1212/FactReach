...
def _require_browser_extractable(spec: PlatformSpec) -> None:
    ...
    if manual_key:
        raise ValueError(
            ...
            f"`factreach configure {manual_key}`."
        )
...
def _sync_xfetch_session(auth_token: str, ct0: str) -> bool:
    ...
    try:
        ...
        # Non-fatal: factreach config is the source of truth, xfetch sync is best-effort
        return False
...
def _sync_bird_env(auth_token: str, ct0: str) -> bool:
    ...
    try:
        ...
        # Non-fatal: factreach config is the source of truth, bird env sync is best-effort
        return False
